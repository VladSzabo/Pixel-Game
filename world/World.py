...
class Map:
    ...
    def render(game_display):
        ...
        for i in range(int(player_coord[1] - Constants.map_height_screen / 2),
                       int(player_coord[1] + Constants.map_height_screen / 2) + 1):
            for j in range(int(player_coord[0] - Constants.map_width_screen / 2),
                           int(player_coord[0] + Constants.map_width_screen / 2) + 1):
